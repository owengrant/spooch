...
public class Keys {
    ...
    private static class ForeignKeys0 {
        public static final ForeignKey<CommentRecord, EventRecord> COMMENT__COMMENT_EID_FKEY = Internal.createForeignKey(io.pet.database.Keys.EVENT_PKEY, Comment.COMMENT, "comment__comment_eid_fkey", Comment.COMMENT.EID);
        public static final ForeignKey<CommentRecord, UserRecord> COMMENT__COMMENT_UID_FKEY = Internal.createForeignKey(io.pet.database.Keys.USER_PKEY, Comment.COMMENT, "comment__comment_uid_fkey", Comment.COMMENT.UID);
        public static final ForeignKey<EventRecord, UserRecord> EVENT__EVENT_UID_FKEY = Internal.createForeignKey(io.pet.database.Keys.USER_PKEY, Event.EVENT, "event__event_uid_fkey", Event.EVENT.UID);
        public static final ForeignKey<TagRecord, EventRecord> TAG__TAG_EID_FKEY = Internal.createForeignKey(io.pet.database.Keys.EVENT_PKEY, Tag.TAG, "tag__tag_eid_fkey", Tag.TAG.EID);
    }
}
