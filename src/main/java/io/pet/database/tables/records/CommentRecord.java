...
public class CommentRecord extends UpdatableRecordImpl<CommentRecord> implements VertxPojo, Record5<Integer, Integer, LocalDateTime, Integer, String> {

    private static final long serialVersionUID = 94483227;
     ...
     */
    @Override
    public CommentRecord values(Integer value1, Integer value2, LocalDateTime value3, Integer value4, String value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CommentRecord(Integer id, Integer eid, LocalDateTime posted, Integer uid, String details) {
        super(Comment.COMMENT);
