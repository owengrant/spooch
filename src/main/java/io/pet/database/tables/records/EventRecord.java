...
public class EventRecord extends UpdatableRecordImpl<EventRecord> implements VertxPojo, Record7<Integer, String, String, LocalDateTime, Point, String, Integer> {

    private static final long serialVersionUID = 1552425837;
     ...
     */
    @Override
    public Row7<Integer, String, String, LocalDateTime, Point, String, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row7<Integer, String, String, LocalDateTime, Point, String, Integer> valuesRow() {
     ...
     */
    @Override
    public EventRecord value4(LocalDateTime value) {
        setPosted(value);
        return this;
    }
     ...
     */
    @Override
    public EventRecord value5(Point value) {
        setLocation(value);
        return this;
    }
     ...
     */
    @Override
    public EventRecord values(Integer value1, String value2, String value3, LocalDateTime value4, Point value5, String value6, Integer value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public EventRecord(Integer id, String caption, String description, LocalDateTime posted, Point location, String photo, Integer uid) {
        super(Event.EVENT);
