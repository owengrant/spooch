...
public class EventRecord extends UpdatableRecordImpl<EventRecord> implements VertxPojo, Record8<Integer, Integer, String, String, LocalDateTime, Point, String, String> {
    ...
    private static final long serialVersionUID = -1179169918;
     ...
     */
    @Override
    public Row8<Integer, Integer, String, String, LocalDateTime, Point, String, String> fieldsRow() {
     ...
     */
    @Override
    public Row8<Integer, Integer, String, String, LocalDateTime, Point, String, String> valuesRow() {
     ...
     */
    @Override
    public EventRecord values(Integer value1, Integer value2, String value3, String value4, LocalDateTime value5, Point value6, String value7, String value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public EventRecord(Integer id, Integer uid, String caption, String description, LocalDateTime posted, Point location, String photo, String category) {
        super(Event.EVENT);
