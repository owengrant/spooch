...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements VertxPojo, Record4<Integer, String, String, String> {

    private static final long serialVersionUID = 1807157461;
    ...
    /**
     * Setter for <code>public.user.event</code>.
     */
    public UserRecord setEvent(String value) {
        set(3, value);
        return this;
    }

    /**
     * Getter for <code>public.user.event</code>.
     */
     ...
     */
    public UserRecord(Integer id, String username, String password, String event) {
        super(User.USER);
