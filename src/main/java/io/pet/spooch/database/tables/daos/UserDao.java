...
public class UserDao extends AbstractAsyncVertxDAO<UserRecord, io.pet.spooch.database.tables.pojos.User, Integer, Future<List<io.pet.spooch.database.tables.pojos.User>>, Future<io.pet.spooch.database.tables.pojos.User>, Future<Integer>, Future<Integer>> implements io.github.jklingsporn.vertx.jooq.classic.VertxDAO<UserRecord,io.pet.spooch.database.tables.pojos.User,Integer> {
    ...
    public UserDao(Configuration configuration, io.vertx.ext.asyncsql.AsyncSQLClient delegate) {
        super(User.USER, io.pet.spooch.database.tables.pojos.User.class, new AsyncClassicQueryExecutor<UserRecord,io.pet.spooch.database.tables.pojos.User,Integer>(configuration,delegate,io.pet.spooch.database.tables.pojos.User::new, User.USER));
    }
     ...
     */
    public Future<List<io.pet.spooch.database.tables.pojos.User>> findManyByEvent(List<String> values) {
        return findManyByCondition(User.USER.EVENT.in(values));
    }

    @Override
    public AsyncClassicQueryExecutor<UserRecord,io.pet.spooch.database.tables.pojos.User,Integer> queryExecutor(){
        return (AsyncClassicQueryExecutor<UserRecord,io.pet.spooch.database.tables.pojos.User,Integer>) super.queryExecutor();
    }
