...
public class CommentRecord extends UpdatableRecordImpl<CommentRecord> implements VertxPojo, Record7<Integer, Integer, LocalDateTime, Integer, String, Short, String> {

    private static final long serialVersionUID = 329508873;
    ...
    /**
     * Setter for <code>public.comment.event</code>.
     */
    public CommentRecord setEvent(String value) {
        set(6, value);
        return this;
    }

    /**
     * Getter for <code>public.comment.event</code>.
     */
     ...
     */
    @Override
    public Row7<Integer, Integer, LocalDateTime, Integer, String, Short, String> fieldsRow() {
     ...
     */
    @Override
    public Row7<Integer, Integer, LocalDateTime, Integer, String, Short, String> valuesRow() {
     ...
     */
    @Override
    public CommentRecord values(Integer value1, Integer value2, LocalDateTime value3, Integer value4, String value5, Short value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CommentRecord(Integer id, Integer eid, LocalDateTime posted, Integer uid, String details, Short rating, String event) {
        super(Comment.COMMENT);
